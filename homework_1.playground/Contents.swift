...
Home Work1
Exercise 2.3
Declare another daysInYear constant and set it to 365.25 (the numbeHr of days in a leap year).
*/
...
print("My age is \(myAge) years. After 10 years, I will be \(myAgeInTenYears) years old. From the moment of my birthday, approximately \(daysPassed) days have passed.")
...
print("Hypotenuse of the triangle AB: \(AB)")
